...
PATH = os.path.join(config.path_to_summaries, 'TALNetV2_FINAL_FINAL/checkpoints/epoch=19-auprc_macro_c=0.760.ckpt')
hparams_file = os.path.join(config.path_to_summaries, 'TALNetV2_FINAL_FINAL/lightning_logs/version_0/hparams_wo_es.yaml')
# Creating model
...
pred_df.to_csv(os.path.join(config.path_to_SONYCUST, "pred_test_TALNETV2.csv"), index = False, header=True)