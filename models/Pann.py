...
class ConvBlock1ConvGN(nn.Conv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1),
        ...
        super(ConvBlock1ConvGN, self).__init__(in_channels, out_channels, kernel_size, stride, padding,
            dilation, groups, bias)

        self.gn = nn.GroupNorm(num_channels=self.out_channels, num_groups=32)
